...
import static com.daniu.constant.Constant.*;
...
public class FileUploadController {
    ...
    public String singleFileUpload(@RequestParam("file") MultipartFile file,
                                   @RequestParam("type") String type, @RequestParam("fileType") String fileType) throws IOException {
        if (file.isEmpty()) {
            return "请选择一个文件上传";
        }
        if (type.isBlank()) {
        ...
        if (fileOriginalFilename.endsWith(type)) {
